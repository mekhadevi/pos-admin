...
module.exports = function registerProductIPC() {
  ...
  ipcMain.handle('products:getMovements', (_, companyId) => {
    return productService.getMovements(companyId);
  });
  ...
  ipcMain.handle('products:adjustStock', (_, { id, qty, note }) => svc.adjustStock(id, qty, note));
